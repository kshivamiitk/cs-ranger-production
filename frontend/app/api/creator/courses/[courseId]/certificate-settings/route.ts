...
import * as backendRoute from '../../../../../../../backend/Learning Engine/routes/creator/courses/[courseId]/certificate-settings/route.ts';

export const GET = withApiTiming(backendRoute.GET, 'GET');
export const PUT = withApiTiming(backendRoute.PUT, 'PUT');
